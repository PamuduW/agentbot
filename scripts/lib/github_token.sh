...
#
# The implementation lives in the dotfiles-shared repository, which this CLI
# and the Dotfiles installer both resolve at runtime. Edit it there; there is
# no vendored second copy to keep in step.
